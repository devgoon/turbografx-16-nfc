...
1. Edit the config file at `cat /dev/shm/screen_manager.cfg` in accordance with [the screen readme](https://github.com/coderkevin/turbograpx-16-nfc/blob/master/screen/README.md)
